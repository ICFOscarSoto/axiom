...
/**
 * @ORM\Entity(repositoryClass="App\Repository\Globale\CompaniesRepository")
 */
class Companies
{
    /**
    ...
    private $deleted;
	 ...
	 /**
     * @ORM\OneToMany(targetEntity="App\Entity\Globale\UserGroups", mappedBy="company")
     */
    private $userGroups;
    ...
    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\Globale\Countries", inversedBy="companies")
     * @ORM\JoinColumn(nullable=false)
     */
    private $country;

    /**
     * @ORM\OneToMany(targetEntity="App\Entity\Globale\Users", mappedBy="company")
     */
    private $users;

    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\Globale\Currencies", inversedBy="companies")
     * @ORM\JoinColumn(nullable=false)
     */
    private $currency;
