 ...
 */
final class Version20181112073244 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE email_accounts (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, name VARCHAR(100) NOT NULL, server VARCHAR(150) NOT NULL, port VARCHAR(4) NOT NULL, protocol VARCHAR(10) DEFAULT NULL, username VARCHAR(150) NOT NULL, password VARCHAR(50) NOT NULL, INDEX IDX_C1AE81E5A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('ALTER TABLE email_accounts ADD CONSTRAINT FK_C1AE81E5A76ED395 FOREIGN KEY (user_id) REFERENCES users (id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP TABLE email_accounts');
