 ...
 */
final class Version20181112175249 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE companies ADD CONSTRAINT FK_8244AA3A38248176 FOREIGN KEY (currency_id) REFERENCES currencies (id)');
