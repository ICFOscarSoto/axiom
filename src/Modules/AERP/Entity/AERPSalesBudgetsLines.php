...
/**
 * @ORM\Entity(repositoryClass="App\Modules\AERP\Repository\AERPSalesBudgetsLinesRepository")
 */
class AERPSalesBudgetsLines
{
    /**
     * @ORM\Id()
     * @ORM\GeneratedValue()
    ...
    /**
     * @ORM\ManyToOne(targetEntity="\App\Modules\AERP\Entity\AERPSalesBudgets")
    ...
    public function getSalesbudget(): ?AERPSalesBudgets
    {
        return $this->salesbudget;
    }

    public function setSalesbudget(?AERPSalesBudgets $salesbudget): self
    {
