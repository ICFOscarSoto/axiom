...
/**
 * @ORM\Entity(repositoryClass="App\Modules\AERP\Repository\AERPSalesInvoicesLinesRepository")
 */
class AERPSalesInvoicesLines
{
    /**
     * @ORM\Id()
     * @ORM\GeneratedValue()
    ...
    /**
     * @ORM\ManyToOne(targetEntity="\App\Modules\AERP\Entity\AERPSalesInvoices")
    ...
    public function getSalesinvoice(): ?AERPSalesInvoices
    {
        return $this->salesinvoice;
    }

    public function setSalesinvoice(?AERPSalesInvoices $salesinvoice): self
    {
