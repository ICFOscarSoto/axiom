...
/**
 * @ORM\Entity(repositoryClass="App\Modules\Globale\Repository\UserGroupsRepository")
 */
class UserGroups
{
    /**
    ...
    /**
     * @ORM\ManyToMany(targetEntity="App\Modules\Globale\Entity\Users", mappedBy="usergroups")
     */
    private $users;

    /**
     * @ORM\ManyToOne(targetEntity="App\Modules\Globale\Entity\Companies", inversedBy="userGroups")
     */
    private $company;

    /**
     * @ORM\OneToMany(targetEntity="App\Modules\Globale\Entity\Notifications", mappedBy="usergroup")
     */
