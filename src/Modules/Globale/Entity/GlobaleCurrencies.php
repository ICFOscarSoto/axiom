...
/**
 * @ORM\Entity(repositoryClass="App\Modules\Globale\Repository\GlobaleCurrenciesRepository")
 */
class GlobaleCurrencies
{
    /**
     * @ORM\Id()
     * @ORM\GeneratedValue()
    ...
    /**
     * @ORM\OneToMany(targetEntity="App\Modules\Globale\Entity\GlobaleCompanies", mappedBy="currency")
     */
    private $companies;
