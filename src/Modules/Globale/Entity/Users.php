...
/**
 * @ORM\Entity(repositoryClass="App\Modules\Globale\Repository\UsersRepository")
...
class Users implements UserInterface
{
    ...
    /**
     * @ORM\ManyToMany(targetEntity="App\Modules\Globale\Entity\UserGroups", inversedBy="usersborrar")
     */
    private $usergroups;

    /**
     * @ORM\OneToMany(targetEntity="App\Modules\Globale\Entity\Notifications", mappedBy="users")
     */
