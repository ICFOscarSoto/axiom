...
class ZonesUtils
{
  public function formatEditor($user, $obj, $request, $controller, $doctrine, $name, $icon){
    ...
    $breadcrumb=$menurepository->formatBreadcrumb('zones');
    ...
    return ['template'=>'@Globale/genericform.html.twig', 'vars'=>array(
        ...
        'userData' => $userdata,
        'form' => ["form" => $form->createView(),"template" => json_decode(file_get_contents (dirname(__FILE__)."/../Forms/Zones.json"),true)]
    )];
  }
