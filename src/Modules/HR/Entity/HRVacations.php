...
class HRVacations
{
    ...
    {
      if ($this->days==null){
         return (date_timestamp_get(new \DateTime())-date_timestamp_get(($this->start!=null)?$this->start: new \DateTime()))%86400;
    ...
    public function preProccess(){
      ...
      $seconds=date_timestamp_get($this->end)-date_timestamp_get($this->start);
