...
{
	private $module='ERP';
	private $class=ERPMyBackpack::class;
	private $utilsClass=ERPMyBackpackUtils::class;

    /**
     * @Route("/{_locale}/ERP/mybackpack/add/{product}/{location}/{quantity}", name="mybackpackadd")
     */
