    ...
    public function index($id, RouterInterface $router,Request $request)
    {
  	...
  	//	$this->router = $router;
		...
		foreach($histories as $key=>$item){
		 ...
		 else $infos[]="Si necesitas ampliar los detalles de la incidencia, puedes hacerlo pinchando en el botón 'Añadir información'. También puedes añadir imágenes si lo necesitas.";
