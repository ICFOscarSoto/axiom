...
class ERPPlazaVoucherReports
{
  ...
  private function docHeader($document){
    ...
    $this->pdf->setX(40);
    $this->pdf->MultiCell(150,4,utf8_decode($document->getSupplier()->getCity().' '.$document->getSupplier()->getPostcode().' '.$document->getSupplier()->getState()->getName()),0,'L',false);
    ...
    $this->pdf->setX(115);
    $this->pdf->MultiCell(90,4,utf8_decode($document->getSupplier()->getCity().' '.$document->getSupplier()->getPostcode().' '.$document->getSupplier()->getState()->getName()),0,'L',false);
