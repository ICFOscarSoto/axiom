...
class ERPPurchasesBudgetsReports
{
  private $pdf;
  private $user;
  ...
  private function docHeader($document){
    ...
    $this->pdf->SetTextColor(0, 0, 0);
    $this->pdf->Cell(60,9,utf8_decode($document->getSupplier()->getCode()),'',0,'L',false);
    $this->pdf->Ln(4);
    $this->pdf->SetTextColor($this->bgcolor_r, $this->bgcolor_g, $this->bgcolor_b);
    ...
    $this->pdf->Cell(60,9,utf8_decode($document->getSuppliername()),'',0,'L',false);
    $this->pdf->setXY(110, 44);
    $this->pdf->Cell(60,9,utf8_decode($document->getSupplieraddress()),'',0,'L',false);
    $this->pdf->setXY(110, 48);
    $this->pdf->Cell(60,9,utf8_decode($document->getSuppliercity()." - ".$document->getSupplierpostcode()." - ".$document->getSupplierstate()),'',0,'L',false);
    ...
    $this->pdf->Cell(60,9,utf8_decode('PRESUPUESTO COMPRA'),'',0,'L',false);
    $this->pdf->setXY($x, $y);
  }
