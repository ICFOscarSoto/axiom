...
class ERPProductsRepository extends ServiceEntityRepository
{
    ...
    */
    ...
    public function latestMovements($product, $limit=200){
      $query='Select code,date,type,quantity,name
              FROM
              (SELECT o.code, o.date, 0 as type, quantity, customername name FROM erpsales_orders o
              ...
              UNION
               SELECT o.code, o.date, 1 as type, quantity, suppliername name FROM erppurchases_orders o
